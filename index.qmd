...
The [ESD glider team project board](https://github.com/orgs/SWFSC/projects/5/views/1){target="_blank"} pulls from issues from several repositories, but in particular the [SWFSC/glider-lab repo](https://github.com/SWFSC/glider-lab){target="_blank"}. For more details see the [best practices](content/best-practices.qmd) page.
...
GitHub repos developed by the ESD glider team. Issues for these repos are tracked in the [ESD glider team project board](https://github.com/orgs/SWFSC/projects/5/views/1){target="_blank"}.
